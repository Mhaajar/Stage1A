...
export default function LoginPage(){
    ...
    const login = () => {
        ...
        axios
        .post("http://localhost:5000/api/utilisateurs/login", infos)
        .then((res) => {
        ...
        <div className="min-h-full h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <div>
                    ...
                    <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white" onClick={login}>Submit</button>
                </div>
